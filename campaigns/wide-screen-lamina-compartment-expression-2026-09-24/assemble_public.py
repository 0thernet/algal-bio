...
SKIP_DIRS = {"data", "panel/data", "damid/data", "lbr/data", "mef/data", "mef/ref", "libvar/data", "libvar/ref", "__pycache__"}
SKIP_FILES = {"features/tiles.base.tsv"}
REPORT_PREFIXES = ("report.md", "results/", "design/", "logs/", "control/result.json", "control/robust_explore.json", "panel/results/", "damid/results/", "lbr/results/", "mef/results/", "libvar/results/", "explore/fine_scale.json")
HOME = "/" + "Users/" + "bg"
