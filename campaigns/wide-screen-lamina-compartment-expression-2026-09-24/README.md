...
8. Third-cohort test `mef/` (GSE124205): mm9 tile features built from UCSC annotation only (`mef/build_mm9_features.py`, `mef/features/`); literature lane (`design/prior-art-mef.md`); registered, reviewed (`design/mef-review.json`, PASS_WITH_REPAIRS, no blocking), frozen 2026-09-25T00:50:52Z before any GSE124205 data file was downloaded (`mef/freeze.json`). This record was published before that download; the outcome follows in a later PR.
