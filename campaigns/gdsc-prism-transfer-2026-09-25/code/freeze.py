#!/usr/bin/env python3
"""Freeze campaign B's registration. Write-once."""
...
REQUIRED = [
    ...
    "registration/selection.csv",
    "registration/gold_controls.json",
    "registration/prefreeze-review.json",
    "prior-art/prior-art-pharmaco.md",
    "README.campaign.md",
    "code/campaign.py", "code/prep.py", "code/screen.py",
    "code/fetch_drug_keys.py", "code/freeze.py",
    "code/fetch_holdout.py", "code/confirm.py",
    "tests/test_pharmaco.py",
    "data/prep/prep.receipt.json", "data/prep/gdsc_inchikey.json",
    "data/prep/prism_inchikey.json", "data/prep/drug_crosswalk.json",
    "data/prep/gdsc2.npz",
]
