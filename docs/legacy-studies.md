> Historical record retained from commit `a712fbec69bd03b10c20d8078b478c38734d9c02`.
> Its measurements and claims have **not been freshly reproduced or independently
> validated by the portable campaign environment**. Source and toolchain gaps
> are recorded in [legacy-evidence.md](legacy-evidence.md). The text below is retained
> as historical reporting, including its corrections and negative findings.
