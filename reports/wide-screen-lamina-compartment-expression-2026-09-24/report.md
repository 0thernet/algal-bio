...
- **POSITIVE (libvar/, below):** a registered four-cohort quantification of GC-correlated same-condition library variation in public lamina DamID/pA-DamID tracks passed all four pre-committed predictions (label SYSTEMATIC): median |rho| 0.141, 68% of 22 pairs ≥ 0.10, median scale-free/raw ratio 0.97, 5/6 pairs in a never-opened quantile-normalized cohort. Two-library GC-vs-lamina contrasts are not identifiable without within-cohort same-condition calibration or an explicit GC-conditioned model.
